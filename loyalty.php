...
<html lang="en-us">
    ...
    <body>
        ...
        <div class="banner content view-height loyalty-banner">
            <img id="loyalty-logo" alt="Chicago Fire Square Points" class="animated fadeInDown" src="/images/loyalty_logo.png">
        ...
        <div id="scrollto" class="content loyalty">
            <h1 class="wow fadeIn" data-wow-delay="0ms">Free to Join. Easy to Earn.</h1>
            <div class="flex-rows loyalty">
                <div class="wow fadeInUp" data-wow-delay="0ms">
                    <img alt="Loyalty Card" src="/icons/loyalty-card.png">
                    <h5>Get a Card</h5>
                ...
                <div class="wow fadeInUp" data-wow-delay="300ms">
                    <img alt="$1 = 1 Point" src="/icons/loyalty-earn.png">
                    <h5>Earn Points</h5>
                ...
                <div class="wow fadeInUp" data-wow-delay="600ms">
                    <img alt="3 Loyalty Tiers" src="/icons/loyalty-tiers.png">
                    <h5>Free Pizza</h5>
        ...
        <div class="content banner loyalty corkage">
            <h5 class="wow fadeInRight" data-wow-delay="0ms">No Corkage Fee</h5>
            <p class="lead wow fadeInRight" data-wow-delay="0ms">Bring in your favorite bottle of wine, Sunday-Thursday and enjoy free corkage.</p>
        </div>
        <div id="loyalty-q-join" class="content loyalty">
            <h1 class="wow fadeIn" data-wow-delay="0ms">Signing up is Fast & Easy.</h1>
            <div class="flex-rows loyalty">
                <div class="wow fadeInUp" data-wow-delay="0ms">
        ...
        <div class="content banner loyalty birthday">
            <h5 class="wow fadeInLeft" data-wow-delay="0ms">Birthday Dessert</h5>
            <p class="lead wow fadeInLeft" data-wow-delay="0ms">Come in any time during the calendar week of your birthday for a free Deep Dish Delight.</p>
        </div>
            ...
            <div class="skylinecontent">
                ...
                <ul>
                    ...
                    <li>Free corkage for any member is limited to one bottle per visit, per table, group or party 
                        and is only valid Sunday through Thursday.</li>
